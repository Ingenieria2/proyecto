...
class PacienteType extends AbstractType
{
  ...
  public function buildForm(FormBuilderInterface $builder, array $options)
  {
    ...
    ->add('fecha_Nac', DateTimeType::class, array("label"=>"Fecha de Nacimiento", 'widget'=>'single_text', 'format'=>'dd/MM/yyyy', "required"=>"required", "attr"=>array("class"=>"form-control", "placeholder"=>"Fecha de Naciemiento")))
