...
class HistoriaClinicaUpdateType extends AbstractType
{
  /**
   * {@inheritdoc}
   */
  public function buildForm(FormBuilderInterface $builder, array $options)
  {
    ...
    ->add('vacunasObservaciones', TextType::class, array(
      ...
      "attr"=>array(
        "class"=>"form-control", 
        "placeholder"=>"Observaciones sobre la vacunas"
        )))
    ...
    ->add('SingUpClinicHistory', SubmitType::class, array('label' => 'Guardar', "attr"=>array("class"=>"btn btn-primary")));
  }
  /**
   * {@inheritdoc}
   */
